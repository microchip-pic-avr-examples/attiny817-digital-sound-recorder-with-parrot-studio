pipeline {
	...
	environment {		
		GITHUB_URL ='https://github.com/microchip-pic-avr-examples/attiny817-digital-sound-recorder-with-parrot-studio.git'
		BITBUCKET_URL = 'https://bitbucket.microchip.com/scm/ebe/attiny817-digital-sound-recorder-with-parrot-studio.git'
